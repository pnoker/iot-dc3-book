...
![图6-3 IoT DC3 模块关系与数据流分层图](../figures/chapter-06/fig-6-03.png){width=15cm}
...
![图6-4 IoT DC3 服务间通信架构图](../figures/chapter-06/fig-6-04.png){width=15cm}

*图6-4 IoT DC3 服务间通信架构：Gateway 与 gRPC 承担同步管理调用，命令、回执和上行数据经 RabbitMQ 异步流转。*
