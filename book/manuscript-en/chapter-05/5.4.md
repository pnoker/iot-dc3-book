...
**Table 5-4** Comparing the data models of relational and time-series databases
...
Using InfluxDB as an example, create a continuous query that automatically computes the average temperature of all sensors every hour:
...
Table 5-5 Hot storage vs. cold storage (example)
