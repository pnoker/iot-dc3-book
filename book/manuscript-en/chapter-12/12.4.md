...
The following is a rough breakdown of initial hardware and communication costs
...
- **TensorFlow for Agriculture**: official TensorFlow tutorials for agricultural use cases (e.g., leaf disease classification, crop counting), paired with public datasets (e.g., PlantVillage); they allow quick reproduction of the CNN training pipeline of Figure 12-2 in this chapter.
