...
- **Is communication encryption enabled?** MQTT uses TLS, on default port 8883; CoAP uses DTLS, on default port 5684; LwM2M mandates DTLS. A test network may disable it temporarily, but production must have it enabled.
