...
What this table covers is "where to look first." The true root cause usually needs the three chains of Section 14.2.3 to judge: registration goes over gRPC, while uplink data and command receipts go over RabbitMQ — first isolate the failing link segment, then dig into the specific component.
