...
When planning the database, store raw point values separately from the outputs of platform computation and model inference. The former go into a time-series database; the latter can go into a vector or relational database. This layering will save you a great deal of data-cleaning time when you introduce AI later (see Chapter 5's discussion of closing the data loop).
