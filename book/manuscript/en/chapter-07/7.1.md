...
The combination of RAG and Tool-Calling means the large language model in IoT operations neither "answers out of thin air" nor "can only talk." The two mechanisms form the operational foundation of intelligent O&M, providing a twofold safeguard for later agent systems to achieve autonomous planning and execution. The view now rises from single tool calls to the system-integration level, to see how these capabilities are exposed to external AI agents through a standard protocol.
