...
# Sliding window: store the latest 10 vibration readings
VIB_WINDOW_SIZE = 10
...
Output:
```
[ALARM] Temperature exceeded and vibration abnormal, local shutdown. Temp mean: 86.0°C, vibration mean: 0.56g
[RECOVER] Temperature and vibration back to normal. Temp mean: 79.0°C, vibration mean: 0.23g
```
