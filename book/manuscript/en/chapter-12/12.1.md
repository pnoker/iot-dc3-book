...
Below is an example of acquisition and MQTT publishing on the sensor node side, written for the ESP8266 (an ESP32 can also run it, but its WiFi library and ADC accuracy differ — adjust per the code comment):
