...
- **TensorFlow for Agriculture**: official TensorFlow tutorials for agricultural use cases (e.g., leaf disease classification, crop counting), paired with public datasets (e.g., PlantVillage); they allow quick reproduction of the CNN training pipeline of Figure 12-4 in this chapter.
