...
**Table 8-1 Compliance checklist**
...
The four functions are not a linear one-shot process. Scenario changes call for re-MAP, version updates call for re-MEASURE, incidents and evaluation results drive MANAGE, and governance policy is then updated by GOVERN. The point of a publication-grade account is not to claim adoption of some framework, but to show an auditable correspondence among risks, controls, metrics, evidence, and owners.
