...
The checklist below (Table 11-7) is divided by deployment phase into four domains: device and protocol compatibility; communication and consistency; data security and authentication; and cross-department coordination and disaster recovery. Each item carries an acceptance criterion and a priority. Items marked High must be locked down at project kickoff to avoid large-scale rework later.

**Table 11-7 Engineering checklist for intelligent transportation system integration**
