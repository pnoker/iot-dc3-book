...
id: "fig-02-02"
type: "flowchart"
title: "图2-2 图2-2 数据采集→理解→决策→执行闭环"
...
IoT DC3 的开源实践印证了这套分工。DC3 在应用层中实现了一个 Agentic 中心，基于工具调用（Tool-Calling）机制，内置一组用于查设备、读写位号、执行命令的接口。Agentic 中心的核心正是智能层的三项职责：它从数据中心读取归一化的位号值进行推理，根据用户意图或异常状态规划动作，通过注入鉴权上下文的指令通道经过网关下发到驱动（资料：[S5]）。该中心兼容 OpenAI API 标准，可接入 GPT、Claude、DeepSeek、通义千问等主流模型（资料：[S5]）。Agentic 中心的工程实现细节——包括工具注册、上下文组装、高耗时操作的异步安全边界——留待第7章展开。
...
id: "fig-02-03"
type: "layered"
title: "图2-3 图2-3 五层架构与传统四层架构对比示意"
...
id: "fig-02-04"
type: flowchart
title: 图2-4 图2-4 传统数据模式与智能闭环模式的数据流程对比
...
id: "fig-02-05"
type: sequence
title: 图2-5 图2-5 智能楼宇节能闭环的组件间交互时序示意图（假设场景）
...
id: "fig-02-06"
type: layered
title: 图2-6 图2-6 智能层在闭环中的推理-规划-执行分工
...
id: "fig-02-07"
type: architecture
title: 图2-7 图2-7 IoT DC3 五大中心逻辑关系
...
id: "fig-02-10"
type: "flowchart"
title: "图2-10 图2-10 规则引擎数据流：温度超标触发报警与自动控制"
...
id: "fig-02-12"
type: "sequence"
title: "图2-12 图2-12 五大中心协同流程（智能灌溉场景）"
...
id: "fig-02-14"
type: "lifecycle"
title: "图2-14 图2-14 学习路径三台阶与自检节点"
