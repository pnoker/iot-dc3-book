...
id: "fig-05-10"
type: architecture
title: 图5-10 工厂设备状态监控系统四层架构图（例子）
...
- L4 云层：InfluxDB 3.x、AI异常检测服务（Python scikit-learn）、Grafana仪表盘、告警服务（SMTP+短信API）。
relationships:
...
caption: 图5-10 工厂设备状态监控系统四层架构图（例子）
visual_constraints:
...
caption: 图5-11 平台层工程检查矩阵。这些检查项来自多个企业级物联网项目设计阶段的复盘，帮助设计者在五个维度上快速定位风险点。
visual_constraints:
- 节点标签使用短名词短语，解释性文字放入 callouts 或正文。
- 图例放在底部，不遮挡主体结构。
