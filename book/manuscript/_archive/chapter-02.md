...
id: "fig-02-08"
type: "sequence"
title: "图2-8 认证流程时序图：用户登录到设备列表访问"
...
caption: "图2-8 用户登录并访问设备列表的完整认证时序。Gateway负责拦截和路由，Auth中心统一处理所有认证和授权判断，Manager只基于用户上下文查询数据。图中展示了两层协作：第一步登录换取令牌，第二步验证令牌和权限并转发业务请求。"
visual_constraints:
